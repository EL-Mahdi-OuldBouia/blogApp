  ...
  return (
    <div className="px-4 h-max sticky top-8">
      ...
      <div className="flex flex-col gap-2 text-sm">
        ...
        <label htmlFor="" className="flex items-center gap-2 cursor-pointer">
          <input
            ...
            name="sort"
            value="most-popular"
            className="appearance-none w-4 h-4 border-[1.5px] border-blue-800 cursor-pointer
             rounded-sm bg-white checked:bg-blue-800"
          />
          Most Popular
        </label>
        <label htmlFor="" className="flex items-center gap-2 cursor-pointer">
      ...
      <div className="flex flex-col gap-2 text-sm">
        ...
        <Link to="/posts?cat=deb-design" className="underline">
          Web Design
        </Link>
